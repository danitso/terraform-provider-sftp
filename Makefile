...
NAME=$$(grep TerraformProviderName sftptf/version.go | grep -o -e 'terraform-provider-[a-z]*')
TARGETS=darwin linux windows
VERSION=$$(grep TerraformProviderVersion sftptf/version.go | grep -o -e '[0-9]\.[0-9]\.[0-9]')
